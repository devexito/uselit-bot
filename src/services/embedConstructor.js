...
class EmbedBuilder {
  ...
  constructor(data = {}) {
      ...
      if (this._title && this._title.length > 256) throw new Error('The _title should not be longer than 256 characters.');
      if (this._description && this._description.length > 2048) throw new Error('The description should not be longer than 2048 characters.');
   ...
   */
  title(title) {
      if (title.length > 256) throw new Error('The _title should not be longer than 256 characters.');
      this._title = title;
      return this;
  }
